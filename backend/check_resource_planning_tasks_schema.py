...
print("resource_planning_tasks table structure:")
print("-" * 80)
...
cursor.execute("""
    ...
    WHERE c.object_id = OBJECT_ID('resource_planning_tasks')
...
cursor.execute("""
    ...
    WHERE fk.parent_object_id = OBJECT_ID('resource_planning_tasks')
""")
...
cursor.execute("SELECT TOP 3 * FROM resource_planning_tasks")
