...
- [x] 3.1 Run focused and full frontend tests.
- [x] 3.2 Run typecheck, lint, production build, and strict OpenSpec validation.
- [x] 3.3 Verify requirements 2.1–2.5 in the rendered schedule page with visual evidence.
