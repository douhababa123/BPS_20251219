...
- [x] 2.1 Add failing tests for connected/FULL_DAY, AM, and PM vertical ordering.
- [x] 2.2 Replace half-column packing with stable full-width vertical rows.

## 3. Complete task cards and connected height

- [x] 3.1 Add failing component tests for complete wrapping, secondary metadata, height reporting, and shared height application.
- [x] 3.2 Implement natural-height task cards and first-fragment measurement.

## 4. Calendar integration

- [x] 4.1 Add failing renderer tests for single-column full-width cards and shared connected height.
- [x] 4.2 Convert assigned and unassigned date cells to vertical rendering.
- [x] 4.3 Set header and body date cells to a 100px minimum width.
