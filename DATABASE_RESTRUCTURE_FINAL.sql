-- ========================================
-- Supabase 数据库重构 SQL 脚本 (最终修复版)
-- 日期：2025-11-24
-- 修复：PostgreSQL语法兼容性问题
-- ========================================
...
-- 测试查询视图（应该不报错）
select '测试视图查询...' as status;
select count(*) as assessments_full_count from view_assessments_full;
select count(*) as employee_gaps_count from view_employee_gaps;
select count(*) as skill_gaps_count from view_skill_gaps;
select count(*) as department_gaps_count from view_department_gaps;

select '✓ 数据库重构完成！' as result;
